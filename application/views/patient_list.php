		<div class="panel panel-default">
			...
			<!-- Table -->
			<table class="table table-hover table-responsive patient-list" data-object="patient" data-delete-url="<?= site_url('patient/delete/') ?>">
				<thead>
					<th>Patient ID</th>
					<th>Patient name</th>
					<th>Sex</th>
				...
				<tbody>
					{patient_entries}
					<tr class='item' data-href="<?= site_url('patient/edit/{id}') ?>" data-id="{id}" >
						<td>{id}</td>
						<td>{name}</td>
						<td>{sex}</td>
						<td>{dob}</td>
			...
			<a href="<?= site_url('patient/add') ?>" class="btn btn-default">
